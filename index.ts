...
import { Command, Events, ClientExtensionInterface, ClientFunctionInterface } from "./types"
...
const commandFolderPath:string = "./commands"
const eventFolderPath:string = "./events"
